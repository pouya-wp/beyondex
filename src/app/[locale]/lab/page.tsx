...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!isLocale(locale))return {};return localizedMetadata({locale,path:'/lab',title:locale==='fa'?'آزمایشگاه تعامل':'Interaction lab',description:locale==='fa'?'۶۰ تجربهٔ تعاملی در حرکت، فرم و طراحی.':'60 interactive studies in motion, form and design.'});}
